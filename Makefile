...
.PHONY: bootstrap pull fleet-setup fleet-enable fleet-disable mysql-tune collect collect-backups instrument-on instrument-off pprof-view netdata-view finish publish bench help
